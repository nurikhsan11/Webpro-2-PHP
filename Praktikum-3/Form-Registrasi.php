...
<body>
    ...
    ?>
    <fieldset class="form-group" style="background-color: #66cccc;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="row" method="POST">
                        ...
                        <div class="col-1 mx-lg-auto">
                            <input type="submit" value="Simpan" name="proses" class="btn btn-secondary px-4">
                        </div>
                    </form>
                    <?php
                    error_reporting(0);
                    ...
                    if (!empty($proses)) {
                        ...
                        echo '<br>Program Studi : ' . $program_studi;
